CREATE EXTERNAL TABLE IF NOT EXISTS ppiv_ref.iv_tgatgd5(
...
LINES TERMINATED BY '\n'
STORED AS TEXTFILE
LOCATION '/data1/GARES/refinery/PPIV_PHASE2/hive/iv_tgatgd5'
...
ALTER TABLE ppiv_ref.iv_tgatgd SET TBLPROPERTIES ('SASFMT:date_extract'='DATE(9)');
...
ALTER TABLE ppiv_ref.iv_tgatgd SET TBLPROPERTIES ('SASFMT:affichage_duree1_minutes'='CHAR(10)');
...
ALTER TABLE ppiv_ref.iv_tgatgd SET TBLPROPERTIES ('SASFMT:affichage_duree_2minutes'='CHAR(10)');
...
ALTER TABLE ppiv_ref.iv_tgatgd SET TBLPROPERTIES ('SASFMT:quai_devoiement'='CHAR(20)');
ALTER TABLE ppiv_ref.iv_tgatgd SET TBLPROPERTIES ('SASFMT:quai_devoiement2'='CHAR(20)');
ALTER TABLE ppiv_ref.iv_tgatgd SET TBLPROPERTIES ('SASFMT:quai_devoiement3'='CHAR(20)');
ALTER TABLE ppiv_ref.iv_tgatgd SET TBLPROPERTIES ('SASFMT:quai_devoiement4'='CHAR(20)');
