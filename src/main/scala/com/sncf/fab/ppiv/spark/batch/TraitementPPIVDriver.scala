...
object TraitementPPIVDriver extends Serializable {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val data = BuildCycleOver.loadDataFullPeriod(sc,sqlContext,"TGA",date,date).toDF()
    ...
    hiveContext.sql("INSERT INTO TABLE ppiv_ref.iv_tgatgdinput_6 select * from dataToSaveToHive")
