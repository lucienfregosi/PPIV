  ...
  def formatTgaTgdOuput(dfTgaTgd: DataFrame, sqlContext : SQLContext, panneau: String) : DataFrame = {
    ...
    val affichageFinal =  dfTgaTgd.map(row => {
      ...
      val v3 = NDerniersChamps(
        BusinessConversion.getQuaiDevoiement(row.getSeq(16)),
        BusinessConversion.getQuaiDevoiement(row.getSeq(17)),
        BusinessConversion.getQuaiDevoiement(row.getSeq(18)),
        BusinessConversion.getQuaiDevoiement(row.getSeq(19)),
        row.getString(15),
        BusinessConversion.getNbTotaldevoiement(row.getSeq(16), row.getSeq(17), row.getSeq(18),row.getSeq(19)),
        BusinessConversion.getNbDevoiement_affiche (row.getSeq(16), row.getSeq(17), row.getSeq(18),row.getSeq(19)) ,
        BusinessConversion.getNvDevoiement_non_affiche (row.getSeq(16), row.getSeq(17), row.getSeq(18),row.getSeq(19)),
        row.getSeq(16)(2),
        row.getSeq(17)(2),
        row.getSeq(18)(2),
        row.getSeq(19)(2),
        BusinessConversion.getCracDevoiement (row.getSeq(16), row.getSeq(17), row.getSeq(18),row.getSeq(19)),
